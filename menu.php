...
<head>
  ...
  <meta name="keywords" content="カスタム,サンドウィッチ,カフェ">
  <meta name="viewport" content="width=device-width,initial-scale=1.0">
  <title>メニュー | SandwichDay | カスタムサンドウィッチカフェ</title>
  <meta name="description" content="当店一押しのグランドサンドウィッチメニューです。スマホでご注文いただけます。">
    ...
    <main>
      ...
      <div class="container-wrap">
        <section class="menu-box clearfix">
          <h2>当店一押しのグランドサンドウィッチメニュー<br></h2>

<!--1つ目-->
          <div class="menu-container">
            <dl class="menu-content">
              <dt class="menu-img">
                <img src="images/menu-avo.png" width="500" height="550" alt="#">
              </dt>
              <div class="menu-item">
                <dd>アボカドとサラダチキンサンド</dd>
                <dd class="en">English English English</dd>
                <dd class="type"><span>全粒粉食パン</span></dd>
                <dd class="price">680</dd>
                <dd class="kcal">390kcal</dd>
              </div><!--/menu-item-->
            </dl><!--/menu-content-->
<!--1つ目ここまで-->
<!--2つ目-->
            <dl class="menu-content">
              <dt class="menu-img">
                <img src="images/menu-tomato.png" width="500" height="550" alt="#">
              </dt>
              <div class="menu-item">
                <dd>贅沢ジューシー！ローストビーフサンド</dd>
                <dd class="en">English English English</dd>
                <dd class="type"><span>全粒粉食パン</span></dd>
                <dd class="price">780</dd>
                <dd class="kcal">243kcal</dd>
              </div><!--/menu-item-->
            </dl><!--/menu-content-->
<!--2つ目ここまで-->
<!--3つ目-->
            <dl class="menu-content">
              <dt class="menu-img">
                <img src="images/menu-egg.png" width="500" height="550" alt="#">
              </dt>
              <div class="menu-item">
                <dd>新鮮卵たっぷりシャキっときゅうりサンド</dd>
                <dd class="en">English English English</dd>
                <dd class="type"><span>全粒粉食パン</span></dd>
                <dd class="price">480</dd>
                <dd class="kcal">343kcal</dd>
              </div><!--/menu-item-->
            </dl><!--/menu-content-->
<!--3つ目ここまで-->
<!--4つ目-->
