...
<head>
  ...
  <title>こだわり | SandwichDay | カスタムサンドウィッチカフェ</title>
  <meta name="description" content="当店のこだわり パンへのこだわり、国産野菜100％へのこだわり 価格へのこだわり">
  ...
  <div class="wrapper">
    ...
    <main>
     ...
     <div class="container-wrap ">
        <section class="fussy-box">
         <h2>こだわり<br><span>FUSSY</span></h2>
<!--1つ目-->
           <div class="fussy-container clearfix">
            <div class="fussy-text">
              <h3>パンへのこだわり</h3>
              <p>小麦ソムリエが選んだ、国産野菜にぴったりの小麦を厳選しています。毎朝ていねいに焼き上げる、風味豊かなパンをご賞味ください。</p>
            </div><!--/fussy-text-->
            <p class="fussy-img">
             <img src="images/fussy-01.png" width="400" height="380" alt="パンへのこだわり">
            </p>
           </div><!--/fussy-container-->
<!--1つ目ここまで-->
<!--2つ目-->
          <div class="fussy-container clearfix">
            <div class="fussy-text">
              <h3>国産野菜100％へのこだわり</h3>
              <p>国産野菜100％で作るサンドウィッチをもっと身近に。契約農家から取り寄せる、新鮮な野菜を。季節によって追加されるトッピングもございます。</p>
            </div><!--/fussy-text-->
            <p class="fussy-img">
             <img src="images/fussy-02.png" width="400" height="380" alt="国産野菜100％へのこだわり">
            </p>
           </div><!--/fussy-container-->
<!--2つ目ここまで-->
<!--3つ目-->
          <div class="fussy-container clearfix">
            <div class="fussy-text">
             <h3>価格へのこだわり</h3>
              <p>毎日、気軽に野菜を食べて欲しいという願いから、リーズナブルな価格設定をしております。カスタムしていろいろな組み合わせをお楽しみください。</p>
            </div><!--/fussy-text-->
            <p class="fussy-img">
             <img src="images/fussy-03.png" width="400" height="380" alt="価格へのこだわり">
            </p>
           </div><!--/fussy-container-->
<!--3つ目ここまで-->
        </section><!--/fussy-box-->
